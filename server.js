...
app.get('/player_info/select_player', function(req, res) {
  ...
  var query3 = 'SELECT count(*) FROM football_games INNER JOIN football_players ON football_players.id = ' + player_id + ';';
  // console.log(query2);
  // console.log(query3);W
...
// app.get('/team_stats', function(req, res) {
  // var query1 = 'select * from football_games;';
  // var query2 = 'select count(visitor_score>home_score) from football_games;';
  // var query3 = 'select count(visitor_score<home_score) from football_games;';
  // db.task('get-everything', task => {
  //     return task.batch([
  //         task.any(query1),
  //         task.any(query2),
